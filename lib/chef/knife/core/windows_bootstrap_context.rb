    ...
    module Core
      ...
      class WindowsBootstrapContext < BootstrapContext
        ...
        def start_chef
          ...
          start_chef = "SET \"PATH=%SystemRoot%\\system32;%SystemRoot%;%SystemRoot%\\System32\\Wbem;%SYSTEMROOT%\\System32\\WindowsPowerShell\\v1.0\\;C:\\ruby\\bin;#{ChefConfig::Config.c_opscode_dir}\\#{ChefUtils::Dist::Infra::DIR_SUFFIX}\\bin;#{ChefConfig::Config.c_opscode_dir}\\#{ChefUtils::Dist::Infra::DIR_SUFFIX}\\embedded\\bin\;%PATH%\"\n"
          start_chef << "#{ChefUtils::Dist::Infra::CLIENT} -c #{ChefConfig::Config.etc_chef_dir(true)}/client.rb -j #{ChefConfig::Config.etc_chef_dir(true)}/first-boot.json#{bootstrap_environment_option}\n"
        end
