      ...
      class <<self
        ...
        def build_from_file(cookbook_name, filename, run_context)
          ...
          unless resource_class.unified_mode
            Chef.deprecated :unified_mode, "The #{resource_name} resource in the #{cookbook_name} cookbook should declare `unified_mode true` or `unified_mode false`. Unified Mode provides a simpler resource execution system collapsing the compile and converge phases into a single phase that reduces common errors. In a future release of #{ChefUtils::Dist::Infra::PRODUCT} Mode will be on by default."
          end
