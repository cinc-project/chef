  ...
  class Resource
    class WindowsUpdateSettings < Chef::Resource
      ...
      **Set Windows Update settings**:
      ...
      property :automatic_update_option, Integer, default: 4, description: "An Integer value to tell nodes when and how to download updates.", default_description: "4 - Auto-download and schedule updates to install"
      ...
      property :scheduled_install_day, String, equal_to: DAYS, default: DAYS.first, description: "A day of the week to tell Windows when to install updates. Defaults to Everyday"
