  ...
  class Resource
    ...
    def self.allowed_actions(*actions)
      ...
      actions.each do |element|
        case element
        when Array # array of strings/symbols. Should not be possible,
          # TODO confirm - Array within actions shouldn't happen.
          raise "HEY! Delete this code already"
